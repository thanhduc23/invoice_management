...
const InvoiceHead: React.FC<InvoiceHeadProps> = ({ status, children }) => {
  return (
    <div className="flex justify-between px-8 py-5 bg-[#FFFFFF] dark:bg-[#1E2139] rounded-md border-solid border-2 dark:border-none">
      ...
      <div className="hidden gap-x-5 sm:flex">{children}</div>
    </div>
  );
};
